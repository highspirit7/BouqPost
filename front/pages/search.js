...
import { INITIATE_DISPLAYED_POSTS, REMOVE_POST_REQUEST } from "../redux/modules/post";
...
const SearchPage = () => {
	...
	return (
		<>
			<StyledSearch placeholder="검색어를 입력해주세요" onSearch={value => console.log(value)} />
			{/* <StyledPostbox>
				<h1>검색된 포스트</h1>
